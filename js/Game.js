class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      {x: width / 2 + 150, y: height - 1300, image: obstacle2Image },
      { x: width / 2 - 250, y: height - 1500, image: obstacle2Image },
      { x: width / 2 + 180, y: height - 4000, image: obstacle2Image },
      { x: width / 2 - 150, y: height - 3900, image: obstacle2Image },
      { x: width / 2, y: height - 3400, image: obstacle2Image },
      { x: width / 2 - 150, y: height - 5000, image: obstacle2Image },
      { x: width / 2 + 100, y: height - 4800, image: obstacle2Image },
    ]
